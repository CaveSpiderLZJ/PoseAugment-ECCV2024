...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, num_frames=1, sampling="conseq", sampling_step=1, split="train",
        ...
        self.num_frames = num_frames        # 60
        self.sampling = sampling            # conseq
        self.sampling_step = sampling_step  # 1
        self.split = split                  # train
        self.pose_rep = pose_rep            # rot6d
        self.translation = translation      # True
        self.glob = glob                    # True
        self.max_len = max_len              # -1
        self.min_len = min_len              # -1
        self.num_seq_max = num_seq_max      # -1
