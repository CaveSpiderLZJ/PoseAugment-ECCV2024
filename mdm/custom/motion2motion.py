...
def main():
    ...
    for batch_idx, (_, model_kwargs) in enumerate(data):
        if batch_idx < start or batch_idx >= end: continue
        
        print(f'### Sampling batch {batch_idx}/{len(data)} ...')
        ...
        npy_path = os.path.join(out_path, f'results_{batch_idx}_t200.npy')
