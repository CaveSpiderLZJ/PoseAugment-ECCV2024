...
class HumanML3D(data.Dataset):
    def __init__(self, mode, datapath='./dataset/humanml_opt.txt', split="train", **kwargs):
        ...
        if mode == 'gt':
            ...
            # used by our models
            self.mean = np.load(pjoin(opt.data_root, 'Mean.npy'))   # shape = (263,)
            self.std = np.load(pjoin(opt.data_root, 'Std.npy'))     # shape = (263,)
        ...
        # len(self.t2m_dataset) == 4882, if split == 'test'
